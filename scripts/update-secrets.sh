...
python /opt/rpc-openstack/scripts/update-yaml.py --output-file /etc/openstack_deploy/user_rpco_secrets.yml $RPCD_DIR/etc/openstack_deploy/user_rpco_secrets.yml $OVERRIDES
python $OA_DIR/scripts/pw-token-gen.py --file /etc/openstack_deploy/user_rpco_secrets.yml
